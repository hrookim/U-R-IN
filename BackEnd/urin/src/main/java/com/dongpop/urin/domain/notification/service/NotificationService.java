...
public class NotificationService {
    ...
    public SseEmitter subscribe(Integer memberId, String lastEventId) {
        ...
        asyncNotificationService.sendNotification(emitter, eventId, emitterId, "EventStream Created. [userId=" + memberId + "]");
    ...
    public void send(NotificationEventDto notificationEventDto) {
        ...
        for (Map.Entry<String, SseEmitter> entry : emitters.entrySet()) {
            ...
            asyncNotificationService.sendNotification(entry.getValue(), eventId, entry.getKey(), event);
        }
    }
    ...
    private void sendLostData(String lastEventId, Integer memberId, String emitterId, SseEmitter emitter) {
        ...
        eventCaches.entrySet().stream()
                ...
                .forEach(entry -> asyncNotificationService.sendNotification(emitter, entry.getKey(), emitterId, entry.getValue()));
    }
}
